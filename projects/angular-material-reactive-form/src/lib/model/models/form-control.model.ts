...
export class FormControlModel<T> extends FormControl
	...
	constructor(options: FormItemInterface<T> = {} as FormItemInterface<T>) {
		...
		this.formControlType =
			options.formControlType || FormControlTypeEnum.INPUT;
		...
		this.customization =
			options.customization || ({} as FormCustomizationInterface);
